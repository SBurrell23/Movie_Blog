<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.4.8/angular.min.js"></script>
    ...
    <!-- header -->
	<h1 class="page-header">Mike & Steve's Movie Blog<small ng-cloak> - {{data.length}}</small></h1>

	<div ng-cloak>
		<div ng-init='data=<?php echo file_get_contents("./movieblog/movieData.json"); ?>'>
			<div style="margin-top:-70px;margin-bottom:20px;float:right;"><input class="form-control" style="width:250px;" placeholder="Search table..." ng-model="searchText"></div>
